...
values
('Omelet', 'Egg omelet with choice of toppings', '9.99', 3, 1, now()),
...
values 
('Emily', 'Carter', '555-214-7832', 'emily.carter@example.com', now()),
('Darien', 'Nguyen', '555-642-1198', 'darien.nguyen@example.com', now()),
('Sophia', 'Martinez', '555-873-4506', 'sophia.martinez@example.com', now());
...
values
(1, '742 Evergreen Terrace', 'Springfield', 'Illinois', '62704', 'USA', 1),
(2, '123 Maplewood Drive', 'Vancouver', 'British Columbia', 'V6Z1K7', 'Canada', 1),
(3, '742 Evergreen Terrace', 'Sherbrooke', 'Quebec', 'J1G4B5', 'Canada', 1);

-- Inserting Employees
Insert into employee (username, full_name, role, hired_date, active)
values
('bthompson', 'Benjamin Thompson', 'Cook', '2023-03-18', 1),
('lroberts', 'Lillie Roberts', 'Cashier', '2024-07-02', 1),
('mfernandez', 'Miguel Fernandez', 'Driver', '2022-09-05', 1),
('swhite', 'Sara White', 'Manager', '2021-12-11', 1),
('kjones', 'Kevin Jones', 'Other', '2025-01-04', 1);
...
values
(1, 1, '2025-12-01 09:10:00', 'Delivered', '35.95', null, '2025-12-01 09:45:00', '2025-12-01 09:45:00'),
(2, 2, '2025-12-01 11:05:00', 'Out for Delivery', '39.94', null, null, '2025-12-01 11:30:00'),
(3, 3, '2025-12-01 12:20:00', 'Cancelled', '22.98', 'Customer Cancellation', null, '2025-12-01 12:30:00');

-- Insert Order Items (Order #1)
